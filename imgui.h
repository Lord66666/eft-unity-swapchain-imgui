...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderIntRub(const char* label, int* v, int v_min, int v_max, const char* format = "%dk", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderIntMeters(const char* label, int* v, int v_min, int v_max, const char* format = "%dm", ImGuiSliderFlags flags = 0);
