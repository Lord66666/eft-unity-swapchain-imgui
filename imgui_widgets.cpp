...
{
    return window->GetIDNoKeepAlive(axis == ImGuiAxis_X ? xor ("#MCZOX") : xor ("#MCZOY"));
}
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    ImColor check_col = hovered ? ImColor(91.f / 255.f, 91.f / 255.f, 91.f / 255.f, alphas / 255.f) : ImGui::GetColorU32(ImGuiCol_FrameBg);
...
bool ImGui::BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags)
{
    ...
    char name[16];
    ImFormatString(name, IM_ARRAYSIZE(name), xor ("##Hzom_%02d"), g.BeginPopupStack.Size); // Recycle windows based on depth
...
bool ImGui::DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    else if (data_type == ImGuiDataType_S32 && strcmp(format, xor ("%d")) != 0) // (FIXME-LEGACY: Patch old "%.0f" format string to use "%d", read function more details.)
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (format == NULL)
        format = GetDataTypeFormat(data_type);
    else if (data_type == ImGuiDataType_S32 && strcmp(format, xor ("%d")) != 0)
        format = PatchFormatStringFloatToInt(format);
